require(plotly)
setwd("~/dev/r-project-2019/results/")
...
fivenum_100 <- fivenum(df$vector_100)
fivenum_1000 <- fivenum(df$vector_1000)
fivenum_4000 <- fivenum(df$vector_4000)
fivenum_5000 <- fivenum(df$vector_5000)
fivenum_10000 <- fivenum(df$vector_10000)
